...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit About Us data
            </h6>
        </div>
        <div class="card-body">
        <?php
        ...
        foreach($query_run as $row){
            ...
            <div class="form-group">
              ...
              <input type="text" name="edit_description" value="<?php echo $row['description']?>" class="form-control" placeholder="Enter your Description">
            </div>
            <div class="form-group">
              <label>Links</label>
